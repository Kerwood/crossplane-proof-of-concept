module github.com/crossplane/function-xappregistration

go 1.25.0

require (
	composer v0.0.0-00010101000000-000000000000
	...
	github.com/upbound/provider-azuread/v2 v2.2.0
	k8s.io/api v0.35.1
...
require (
	...
	github.com/crossplane/upjet/v2 v2.0.1-0.20251028081228-8d73164bb9bd // indirect
...
exclude github.com/kerwood/crossplane-xrd-generator/resources v0.0.0-20260217140641-07e9972a2bd9
